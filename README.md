...
[![Release pipeline](https://ci.eionet.europa.eu/buildStatus/icon?job=volto%2Fclms-frontend%2F2.38.0&build=last&subject=release%20v2.38.0%20pipeline)](https://ci.eionet.europa.eu/view/Github/job/volto/job/clms-frontend/job/2.38.0/lastBuild/display/redirect/)
